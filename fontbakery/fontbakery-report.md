...
* 🔥 **FAIL** Ubuntu Regular: OS/2 sTypoAscender is 776 when it should be 932 [code: bad-typo-ascender]
* 🔥 **FAIL** Ubuntu Regular: OS/2 sTypoDescender is -185 when it should be -189 [code: bad-typo-descender]
...
* 🔥 **FAIL** OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/ttf/Ubuntu-LightItalic.ttf', 'fonts/ttf/Ubuntu-Thin.ttf', 'fonts/ttf/Ubuntu-MediumItalic.ttf', 'fonts/ttf/Ubuntu-Light.ttf', 'fonts/ttf/Ubuntu-BoldItalic.ttf', 'fonts/ttf/Ubuntu-Bold.ttf', 'fonts/ttf/Ubuntu-Regular.ttf', 'fonts/ttf/Ubuntu-Condensed.ttf', 'fonts/ttf/Ubuntu-Medium.ttf', 'fonts/ttf/Ubuntu-Italic.ttf']. [code: missing-os2-fsselection-bit7]
