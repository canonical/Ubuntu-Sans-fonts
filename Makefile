...
build.stamp: venv .init.stamp sources/config.yaml $(SOURCES)
	. venv/bin/activate; rm -rf fonts/; gftools builder sources/config.yaml && touch build.stamp; rm -rf instance_ufo/; python3 scripts/fixStaticsNames.py; python3 scripts/fixTTHinting.py; python3 scripts/makeWebfonts.py
